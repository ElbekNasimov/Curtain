package com.example.curtain.entities;
...
public class Product {
    ...
    private String prHeight;
    private String prMass;
    private String prComp;
    private String prOldPrice;
    private String prDiscNote;
    private String prEditAt;
    private String prEditBy;

    public Product(@NonNull String prId, String prTitle, String prCat, String prBarcode, String prDesc,
                   String prPrice, String prCost, String created_at, String created_by, String prHeight,
                   String prMass, String prComp, String prOldPrice, String prDiscNote, String prEditAt, String prEditBy) {
        this.prId = prId;
    ...
    public void setPrId(@NonNull String prId) {
        this.prId = prId;
    }
    ...
    public String getPrEditAt() {
        return prEditAt;
    }

    public void setPrEditAt(String prEditAt) {
        this.prEditAt = prEditAt;
    }
